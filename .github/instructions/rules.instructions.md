...
applyTo: Always apply # when provided, instructions will automatically be added to the request context when the pattern matches an attached file
---
...
**IMPORTANT: The development plan to consider in priority is the one contained in the file `plan-developpement-ocanada.md`. This plan outlines the detailed phases and must guide all development activities.**
