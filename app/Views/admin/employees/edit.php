    ...
    <div class="d-flex flex-column flex-lg-row align-items-lg-end justify-content-between gap-3">
        <div>
            <span class="page-hero-chip mb-3 d-inline-flex align-items-center gap-2">
                ...
                Mise a jour dossier RH
            </span>
            <h1 class="page-hero-title mb-2">Modifier employe</h1>
            <p class="page-hero-copy mb-0">Ajustez les informations administratives et statutaires de ce collaborateur.</p>
        </div>
        <a href="<?= site_url('admin/employees/' . $employe['id']) ?>" class="btn btn-light border">
            <i class="bi bi-arrow-left me-2"></i>Retour au detail
        </a>
    </div>
</section>
...
<div class="card">
    <div class="card-body">
        <form action="<?= site_url('admin/employees/' . $employe['id'] . '/update') ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="tel" class="form-control" id="telephone_1" name="telephone_1"
                        value="<?= esc(old('telephone_1', $employe['telephone_1'] ?? ($employe['telephone'] ?? ''))) ?>">
                    <?php if (isset($errors['telephone_1'])): ?>
                        <div class="text-danger small mt-1"><?= $errors['telephone_1'] ?></div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="telephone_2" class="form-label">Telephone secondaire</label>
                    <input type="tel" class="form-control" id="telephone_2" name="telephone_2"
                        value="<?= esc(old('telephone_2', $employe['telephone_2'] ?? '')) ?>">
                    <?php if (isset($errors['telephone_2'])): ?>
                        <div class="text-danger small mt-1"><?= $errors['telephone_2'] ?></div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="nationalite" name="nationalite"
                        value="<?= esc(old('nationalite', $employe['nationalite'] ?? '')) ?>">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="numero_cni" name="numero_cni"
                        value="<?= esc(old('numero_cni', $employe['numero_cni'] ?? '')) ?>">
                </div>
                <div class="col-md-6">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="poste" name="poste"
                        value="<?= esc(old('poste', $employe['poste'])) ?>" required>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="departement" name="departement" required>
                        ...
                        <option value="Comptabilité" <?= old('departement', $employe['departement']) === 'Comptabilité' ? 'selected' : '' ?>>Comptabilite</option>
                        <option value="Commercial" <?= old('departement', $employe['departement']) === 'Commercial' ? 'selected' : '' ?>>Commercial</option>
                        <option value="Logistique" <?= old('departement', $employe['departement']) === 'Logistique' ? 'selected' : '' ?>>Logistique</option>
                        ...
                        <option value="Technique" <?= old('departement', $employe['departement']) === 'Technique' ? 'selected' : '' ?>>Technique</option>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="salaire_journalier" name="salaire_journalier"
                        value="<?= old('salaire_journalier', $employe['salaire_journalier'] ?? (isset($employe['salaire_base']) ? ((float) $employe['salaire_base'] / 22) : '')) ?>" min="0" step="0.01" required>
                    <?php if (isset($errors['salaire_journalier'])): ?>
                        <div class="text-danger small mt-1"><?= $errors['salaire_journalier'] ?></div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="type_contrat" name="type_contrat">
                        ...
                        <option value="consultant" <?= old('type_contrat', $employe['type_contrat'] ?? '') === 'consultant' ? 'selected' : '' ?>>Consultant</option>
                    </select>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                    ...
                    <input type="time" class="form-control" id="heure_debut_travail" name="heure_debut_travail"
                        value="<?= old('heure_debut_travail', isset($employe['heure_debut_travail']) ? substr((string) $employe['heure_debut_travail'], 0, 5) : '08:00') ?>">
                </div>
                <div class="col-md-3">
                    <label for="heure_fin_travail" class="form-label">Heure fin</label>
                    <input type="time" class="form-control" id="heure_fin_travail" name="heure_fin_travail"
                        value="<?= old('heure_fin_travail', isset($employe['heure_fin_travail']) ? substr((string) $employe['heure_fin_travail'], 0, 5) : '17:00') ?>">
                </div>
                <div class="col-md-6">
                    ...
                    <?php if (isset($errors['statut'])): ?>
                        <div class="text-danger small mt-1"><?= $errors['statut'] ?></div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="adresse" name="adresse"
                        value="<?= esc(old('adresse', $employe['adresse'])) ?>">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="ville" name="ville"
                        value="<?= esc(old('ville', $employe['ville'])) ?>">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="code_postal" name="code_postal"
                        value="<?= esc(old('code_postal', $employe['code_postal'])) ?>">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="pays" name="pays"
                        value="<?= esc(old('pays', $employe['pays'])) ?>">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-md-end gap-2">
                <a href="<?= site_url('admin/employees/' . $employe['id']) ?>" class="btn btn-outline-secondary">Annuler</a>
