                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <button
                                    ...
                                    aria-label="Afficher le détail du pointage de <?= esc($employeeName) ?>"
            ...
            .then(data => {
                if (data.success) {
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-8"><strong>${escapeHtml([p.prenom, p.nom].filter(Boolean).join(' ') || 'Employe introuvable')}</strong></dd>
                        
                        <dt class="col-sm-4">Matricule:</dt>
                        <dd class="col-sm-8"><code>${escapeHtml(p.matricule || 'Matricule indisponible')}</code></dd>
