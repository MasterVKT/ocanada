                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <button 
                                        ...
                                        aria-label="Corriger le pointage de <?= esc(($presence['prenom'] ?? '') . ' ' . ($presence['nom'] ?? 'Inconnu')) ?>"
                                        onclick="openCorrectionForm(<?= $presence['id'] ?>, '<?= esc(($presence['prenom'] ?? '') . ' ' . ($presence['nom'] ?? 'Inconnu'), 'js') ?>', '<?= esc($presence['matricule'] ?? 'N/A', 'js') ?>')"
                                    >
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea 
                            ...
                            rows="3"
                            maxlength="255"
                            placeholder="Ex: Raison de la correction..."
                        ></textarea>
...
async function openCorrectionForm(presenceId, employeNom, matricule) {
    ...
    employeEl.textContent = employeNom || 'Inconnu';
    matriculeEl.textContent = matricule || 'N/A';
