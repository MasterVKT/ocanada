                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="profile-field">
                                ...
                                <div class="profile-field-value"><?= esc(($presence['prenom'] ?? '') . ' ' . ($presence['nom'] ?? '')) ?></div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="profile-field">
                                <div class="profile-field-label">Matricule</div>
                                <div class="profile-field-value badge-time"><?= esc($presence['matricule'] ?? 'N/A') ?></div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="profile-field">
                                <div class="profile-field-label">Date</div>
                                <div class="profile-field-value"><?= isset($presence['date_pointage']) ? (new DateTime($presence['date_pointage']))->format('d/m/Y') : 'N/A' ?></div>
                            </div>
                        </div>
                    </div>
                </div>
