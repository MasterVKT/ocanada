...
(() => {
        ...
        <div class="col-12 col-md-6">
            <article class="realtime-person-card is-success h-100">
                ...
                <div class="flex-grow-1 min-w-0">
                    <div class="realtime-person-name text-truncate">${escapeHtml(presence.nom)} ${escapeHtml(presence.prenom)}</div>
    ...
    const renderVisitorCard = (visiteur) => `
        <article class="realtime-visitor-card">
            ...
            <div class="flex-grow-1 min-w-0">
                <div class="realtime-person-name text-truncate">${escapeHtml(visiteur.nom)} ${escapeHtml(visiteur.prenom)}</div>
    ...
    const renderAbsentCard = (absent) => `
        <div class="col-12 col-md-6 col-xl-4">
            <article class="realtime-person-card is-danger h-100">
                ...
                <div class="flex-grow-1 min-w-0">
                    <div class="realtime-person-name text-truncate">${escapeHtml(absent.nom)} ${escapeHtml(absent.prenom)}</div>
