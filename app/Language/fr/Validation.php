...
return [
    // Core Messages
    'noRuleSets'      => 'Aucune règle de validation n\'a été spécifiée dans la configuration Validation.',
    ...
    'alpha_numeric_punct' => 'Le champ {field} ne peut contenir que des caractères alphanumériques, des espaces et les caractères suivants : ~ ! # $ % & * - _ + = | : .',
    ...
    'exact_length'    => 'Le champ {field} doit être exactement de {param} caractères.',
    ...
    'is_not_unique'   => 'Le champ {field} doit contenir une valeur déjà présente dans la base de données.',
    ...
    'numeric'         => 'Le champ {field} doit contenir uniquement des chiffres.',
    ...
    'valid_json'      => 'Le champ {field} doit contenir une chaîne JSON valide.',
    ...
    'max_size' => '{field} est trop volumineux (maximum {param}).',
    'is_image' => '{field} n\'est pas un fichier image valide.',
    'mime_in'  => '{field} n\'a pas un type MIME valide.',
    'ext_in'   => '{field} n\'a pas une extension de fichier valide.',
    'max_dims' => '{field} n\'est pas une image ou est trop large/haute.',
];